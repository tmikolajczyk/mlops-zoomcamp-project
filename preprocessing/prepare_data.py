...
def data_for_modeling(filename: str) -> Tuple[pd.DataFrame, np.ndarray, MultiColumnLabelEncoder, StandardScaler]:
    ...
    df.drop(['Date_of_Journey', 'Route', 'Dep_Time', 'Arrival_Time', 'Duration', 'Additional_Info'],
            inplace=True,
            axis=1)
    ...
    multi = MultiColumnLabelEncoder(columns=['Airline', 'Source', 'Destination', 'Total_Stops'])
